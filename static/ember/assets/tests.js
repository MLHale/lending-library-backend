...
define('lend-database/tests/integration/components/shopping-cart-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | shopping-cart', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "hBtWe+CF",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"shopping-cart\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "yy3SSAlB",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"shopping-cart\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('lend-database/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/shopping-cart.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/shopping-cart.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/library.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/library.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('models/application-type.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/application-type.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('models/code.js', function (assert) {
    assert.expect(1);
...
define('lend-database/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('lend-database/templates/cart.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'lend-database/templates/cart.hbs should pass TemplateLint.\n\n');
  });
  ...
  QUnit.test('lend-database/templates/components/shopping-cart.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'lend-database/templates/components/shopping-cart.hbs should pass TemplateLint.\n\n');
  });
  ...
  QUnit.test('lend-database/templates/library.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'lend-database/templates/library.hbs should pass TemplateLint.\n\n');
  });
...
define('lend-database/tests/lint/tests.lint-test', [], function () {
  ...
  QUnit.test('integration/components/shopping-cart-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/shopping-cart-test.js should pass ESLint\n\n');
  });
